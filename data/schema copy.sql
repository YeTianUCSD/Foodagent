...
CREATE TABLE `glucose_levels` (
  ...
  `glucose_mg_dl` SMALLINT UNSIGNED,
  PRIMARY KEY (`id`,`ts`),
  FOREIGN KEY (`id`) REFERENCES `participants` (`id`)
    ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pa_active_minutes` (
  `id`                         VARCHAR(20) NOT NULL,
  `day`                        DATE        NOT NULL,        -- 由 timestamp 取日期部分
...
CREATE TABLE `pa_daily_summary` (
  ...
  `min_below_default_zone_1`        SMALLINT UNSIGNED,
  `min_in_default_zone_1`           SMALLINT UNSIGNED,
  `min_in_default_zone_2`           SMALLINT UNSIGNED,
  `min_in_default_zone_3`           SMALLINT UNSIGNED,
  PRIMARY KEY (`id`,`day`),
...
CREATE TABLE `pa_reports` (
  ...
  `duration_sec`                    INT UNSIGNED,              -- duration
  `active_duration_sec`             INT UNSIGNED,
  `calories_kcal`                   DECIMAL(8,2),
  `steps`                           INT UNSIGNED,
  ...
  `out_of_range_min_hr`             DECIMAL(5,2),
  `out_of_range_max_hr`             DECIMAL(5,2),
  `out_of_range_calories`           DECIMAL(8,2),

  `fat_burn_minutes`                SMALLINT UNSIGNED,
  `fat_burn_min_hr`                 DECIMAL(5,2),
  `fat_burn_max_hr`                 DECIMAL(5,2),
  `fat_burn_calories`               DECIMAL(8,2),

  `cardio_minutes`                  SMALLINT UNSIGNED,
  `cardio_min_hr`                   DECIMAL(5,2),
  `cardio_max_hr`                   DECIMAL(5,2),
  `cardio_calories`                 DECIMAL(8,2),

  `peak_minutes`                    SMALLINT UNSIGNED,
  `peak_min_hr`                     DECIMAL(5,2),
  `peak_max_hr`                     DECIMAL(5,2),
 ...
 * --------------------------------------------------------- */
DROP TABLE IF EXISTS `sleep_questionnaire`;
...
CREATE TABLE `additional_sleep` (
  ...
  `minutes_in_deep`   SMALLINT,
  `minutes_in_light`  SMALLINT,
...
CREATE TABLE `stress_daily_scores` (
  `id`                       VARCHAR(20)   NOT NULL,  -- 参与者 ID
  `day`                      DATE          NOT NULL,  -- 由 timestamp 取日期
...
CREATE TABLE `sus_scores` (
  ...
  /* ---------- 10 个题项 原样列名 ---------- */
  `q1_like_to_use`         TINYINT,                           -- 1_like_to_use
  `q2_complex`             TINYINT,                           -- 2_complex
  `q3_easy_to_use`         TINYINT,                           -- 3_easy_to_use
  `q4_need_support`        TINYINT,                           -- 4_technical_support
  `q5_well_integrated`     TINYINT,                           -- 5_well_integrated
  `q6_inconsistent`        TINYINT,                           -- 6_inconsistency
  `q7_quick_to_learn`      TINYINT,                           -- 7_quick_to_learn
  `q8_cumbersome`          TINYINT,                           -- 8_cumbersome
  `q9_confident`           TINYINT,                           -- 9_confident
  `q10_need_to_learn`      TINYINT,                           -- 10_need_to_learn

  /* ---------- 计算列 ---------- */
  `positive_score`         SMALLINT,                          -- 正向项加总×2.5
  `negative_score`         SMALLINT,                          -- 反向项处理后×2.5
  `sum_raw`                SMALLINT,                          -- CSV 列 “sum”
